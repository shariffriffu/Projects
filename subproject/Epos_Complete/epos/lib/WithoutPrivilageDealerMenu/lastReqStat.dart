...
void main() => runApp(const lastReqStat());

class lastReqStat extends StatelessWidget {
  const lastReqStat({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    const appTitle = 'Last Request Status';
    return MaterialApp(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final ussdCode =
                    '*$servicecode*7*$password*888*0*0*0*0*0*$username*860882068612183*0#';
